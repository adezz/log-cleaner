...
// This is Kintaro+, compatible with Kintaro, just decompression is slightly tuned, now an XMM used. A nasty bug was fixed in search function (boundary check), also for speed torture I added the latest (GLIBC 2.24) 'memmem' using Two-Way algorithm. It's interesting to see Eric Blake's TW memmem vs Kaze's Railgun showdown in REAL LOADS (as match finder working in window 256MB long).
// To generate executable using Railgun use:
// icl /O3 /QxSSE2 Nakamichi_Kintaro+.c -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY /FAcs
// To generate executable using TW use:
// icl /O3 /QxSSE2 Nakamichi_Kintaro+.c -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW /FAcs

// This is the actual console dump for GCC compiler:
/*
...
D:\>cd D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>dir

08/06/2016  06:58 PM             3,331 MakeEXEs_GCC_Nakamichi_Kintaro+.bat
08/06/2016  06:58 PM               884 MakeEXEs_ICC_Nakamichi_Kintaro+.bat
08/06/2016  06:58 PM             1,630 MokujIN 224 prompt.lnk
08/10/2016  05:17 PM           301,589 Nakamichi_Kintaro+.c

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>"MakeEXEs_GCC_Nakamichi_Kintaro+.bat"

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>rem RG:

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -S Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.S -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.exe -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_GCC_5.10_64bit_generic.S del Nakamichi_Kintaro+_GCC_5.10_64bit_generic.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_GCC_5.10_64bit_generic.exe del Nakamichi_Kintaro+_GCC_5.10_64bit_generic.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.S Nakamichi_Kintaro+_GCC_5.10_64bit_generic.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+_GCC_5.10_64bit_generic.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -march=haswell -S Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.S -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -march=haswell Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.exe -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.S del Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.exe del Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.S Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>rem TW:

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -S Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.S -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.exe -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.S del Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.exe del Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.S Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -march=haswell -S Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.S -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>gcc -O3 -m64 -fomit-frame-pointer -march=haswell Nakamichi_Kintaro+.c -o Nakamichi_Kintaro+.exe -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.S del Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.exe del Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.S Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.exe
...
08/06/2016  06:58 PM             1,630 MokujIN 224 prompt.lnk
08/10/2016  05:17 PM           301,589 Nakamichi_Kintaro+.c
08/10/2016  05:18 PM            69,151 Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.exe
08/10/2016  05:18 PM            76,449 Nakamichi_Kintaro+TW_GCC_5.10_64bit_generic.S
08/10/2016  05:18 PM            69,151 Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.exe
08/10/2016  05:18 PM            77,875 Nakamichi_Kintaro+TW_GCC_5.10_64bit_haswell.S
08/10/2016  05:18 PM            68,093 Nakamichi_Kintaro+_GCC_5.10_64bit_generic.exe
08/10/2016  05:18 PM            73,070 Nakamichi_Kintaro+_GCC_5.10_64bit_generic.S
08/10/2016  05:18 PM            68,093 Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.exe
08/10/2016  05:18 PM            74,425 Nakamichi_Kintaro+_GCC_5.10_64bit_haswell.S

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>
*/

// This is the actual console dump for Intel compiler:
/*
...
08/06/2016  06:58 PM               884 MakeEXEs_ICC_Nakamichi_Kintaro+.bat
08/06/2016  06:58 PM             1,630 MokujIN 224 prompt.lnk
08/10/2016  05:11 PM           287,299 Nakamichi_Kintaro+.c

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>"MakeEXEs_ICC_Nakamichi_Kintaro+.bat"

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>icl /O3 /QxSSE2 Nakamichi_Kintaro+.c -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY /FAcs
...
-out:Nakamichi_Kintaro+.exe
Nakamichi_Kintaro+.obj

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_Intel_15.0_64bit.exe del Nakamichi_Kintaro+_Intel_15.0_64bit.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+_Intel_15.0_64bit.cod del Nakamichi_Kintaro+_Intel_15.0_64bit.cod

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+_Intel_15.0_64bit.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.cod Nakamichi_Kintaro+_Intel_15.0_64bit.cod

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>icl /O3 /QxSSE2 Nakamichi_Kintaro+.c -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -D_N_TW /FAcs
Intel(R) C++ Intel(R) 64 Compiler XE for applications running on Intel(R) 64, Version 15.0.0.108 Build 20140726
Copyright (C) 1985-2014 Intel Corporation.  All rights reserved.
...
D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_Intel_15.0_64bit.exe del Nakamichi_Kintaro+TW_Intel_15.0_64bit.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>if exist Nakamichi_Kintaro+TW_Intel_15.0_64bit.cod del Nakamichi_Kintaro+TW_Intel_15.0_64bit.cod

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.exe Nakamichi_Kintaro+TW_Intel_15.0_64bit.exe

D:\WorkTemp\Nakamichi_Kintaro+_source_executables_64bit_(GCC510-vs-Intel150)_(TW-vs-RG)>ren Nakamichi_Kintaro+.cod Nakamichi_Kintaro+TW_Intel_15.0_64bit.cod
...
08/06/2016  06:58 PM             1,630 MokujIN 224 prompt.lnk
08/10/2016  05:11 PM           287,299 Nakamichi_Kintaro+.c
08/10/2016  05:12 PM            39,427 Nakamichi_Kintaro+.obj
08/10/2016  05:12 PM         1,207,055 Nakamichi_Kintaro+TW_Intel_15.0_64bit.cod
08/10/2016  05:12 PM           123,392 Nakamichi_Kintaro+TW_Intel_15.0_64bit.exe
08/10/2016  05:12 PM         1,210,475 Nakamichi_Kintaro+_Intel_15.0_64bit.cod
08/10/2016  05:12 PM           120,832 Nakamichi_Kintaro+_Intel_15.0_64bit.exe
...
// Use -D_N_TW at compile line:
// Thierry Lecroq's TW, http://www-igm.univ-mlv.fr/~lecroq/string/node26.html#SECTION00260 [
...
// Use -D_N_TW at compile line:
// Eric Blake's memmem (glibc-2.24.tar) [
void * __memmem (const void *haystack_start, const void *needle_start, size_t haystack_len, size_t needle_len);
...
// SPOILER: Thierry Lecroq's TW is slower than Eric Blake's memmem, Kaze's Railgun is 5++x faster.
...
// 24:2 = 12
	...
	if (refStartHOTEST < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 24);	
	//FoundAtPosition = TW(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 24);	
				#else
	FoundAtPosition = Railgun_Swampshine_BailOut(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 24);	
	//FoundAtPosition2 = Railgun_Ennearch(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 24);	
	//if (FoundAtPosition != FoundAtPosition2) { printf("\n24: "); for (prnt=0;prnt<24;prnt++) printf("%c",*(char *)(encStart+prnt)); printf("EnnearchFoundat= %p; SwampshineFoundat= %p\n",FoundAtPosition2,FoundAtPosition);} 
				#endif
...
// 16:2 =  8
	...
	if (refStartHOTEST < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 16);	
	//FoundAtPosition = TW(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 16);	
				#else
...
// 24:3 = 8
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 24);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 24);	
				#else
	FoundAtPosition = Railgun_Swampshine_BailOut(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 24);	
	//FoundAtPosition2 = Railgun_Ennearch(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 24);	
	//if (FoundAtPosition != FoundAtPosition2) { printf("\n24: "); for (prnt=0;prnt<24;prnt++) printf("%c",*(char *)(encStart+prnt)); printf("EnnearchFoundat= %p; SwampshineFoundat= %p\n",FoundAtPosition2,FoundAtPosition);} 
				#endif
		if (FoundAtPosition!=NULL) {
				*retMatch=24;
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 24);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 24);	
				#else
	FoundAtPosition = Railgun_Swampshine_BailOut(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 24);	
	//FoundAtPosition2 = Railgun_Ennearch(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 24);	
	//if (FoundAtPosition != FoundAtPosition2) { printf("\n24: "); for (prnt=0;prnt<24;prnt++) printf("%c",*(char *)(encStart+prnt)); printf("EnnearchFoundat= %p; SwampshineFoundat= %p\n",FoundAtPosition2,FoundAtPosition);} 
				#endif
		if (FoundAtPosition!=NULL) {
				*retMatch=24;
...
// 12:2 = 8
	...
	if (refStartHOTEST < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 12);	
	//FoundAtPosition = TW(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 12);	
				#else
...
// 24:4 = 6
	...
	if (refStartCOLDERbig < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 24);	
	//FoundAtPosition = TW(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 24);	
				#else
	FoundAtPosition = Railgun_Swampshine_BailOut(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 24);	
	//FoundAtPosition2 = Railgun_Ennearch(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 24);	
	//if (FoundAtPosition != FoundAtPosition2) { printf("\n24: "); for (prnt=0;prnt<24;prnt++) printf("%c",*(char *)(encStart+prnt)); printf("EnnearchFoundat= %p; SwampshineFoundat= %p\n",FoundAtPosition2,FoundAtPosition);} 
				#endif
		if (FoundAtPosition!=NULL) {
				*retMatch=24;
...
// 17:3 =  5.6
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 17);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 17);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 17);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 17);	
				#else
...
// 18:4 =  4.5 
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 18);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 18);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 18);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 18);	
				#else
	...
	if (refStartCOLDERbig < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 18);	
	//FoundAtPosition = TW(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 18);	
				#else
...
// 13:3 =  4.3
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 13);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 13);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 13);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 13);	
				#else
...
// 8:2 =  4
	...
	if (refStartHOTEST < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 8);	
	//FoundAtPosition = TW(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 8);	
				#else
...
// 14:4 =  3.5
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 14);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 14);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 14);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 14);	
				#else
	...
	if (refStartCOLDERbig < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 14);	
	//FoundAtPosition = TW(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 14);	
				#else
...
// 9:3 = 3
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 9);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 9);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 9);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 9);	
				#else
...
// 10:4 =  2.5
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 10);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 10);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 10);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 10);	
				#else
	...
	if (refStartCOLDERbig < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 10);	
	//FoundAtPosition = TW(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 10);	
				#else
...
// 4:2 =  2
	...
	if (refStartHOTEST < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 4);	
	//FoundAtPosition = TW(refStartHOTEST, encStart, (uint32_t)(refEnd-refStartHOTEST), 4);	
				#else
...
// 5:3 =  1.6
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 5);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 5);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 5);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 5);	
				#else
...
// 6:4 =  1.5
	...
	if (refStartHOTTER < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 6);	
	//FoundAtPosition = TW(refStartHOTTER, encStart, (uint32_t)(refEnd-refStartHOTTER), 6);	
				#else
	...
	if (refStartHOT < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 6);	
	//FoundAtPosition = TW(refStartHOT, encStart, (uint32_t)(refEnd-refStartHOT), 6);	
				#else
	...
	if (refStartCOLDERbig < refEnd) {
				#ifdef _N_TW
	FoundAtPosition = __memmem(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 6);	
	//FoundAtPosition = TW(refStartCOLDERbig, encStart, (uint32_t)(refEnd-refStartCOLDERbig), 6);	
				#else
...
//			*(uint64_t*)(retLOCAL+8*(1)) = *(uint64_t*)((srcLOCAL+1)+8*(1)); // |
		...
		srcLOCAL+= ((DWORDtrio>>4)&0x0F)+1;                                      // |
			...
			MatchLen = (DWORDtrio&0x0F); // The idea is this second instance of '(DWORDtrio&0x0F)' to be reused at once.
			if ( (DWORDtrio & 0x03) == 0x00 ) {       
				...
				MatchLen = 24-3; // Total override, no mumbo-jumbo arithmetic.
			}
			MatchLen+= 3;
...
//			*(uint64_t*)(retLOCAL+8*(1)) = *(uint64_t*)((retLOCAL-(DWORDtrio>>4))+8*(1)); 
		...
		retLOCAL+= MatchLen; // 4/5/6, 8/9/10, 12/13/14, 16/17/18, 24 // Kintaro
		}
// Branchfull ]
				#endif
	}        
...
// ; 'Nakamichi_Kintaro+_branchfull' decompression loop, 64bit:
// ; Size in bytes: b9-26+6=153 bytes
// ; Size in instructions: 44
/*
; mark_description "Intel(R) C++ Intel(R) 64 Compiler XE for applications running on Intel(R) 64, Version 15.0.0.108 Build 20140";
; mark_description "-O3 -QxSSE2 -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -FAcs";

.B7.3::                         
  00026 45 8b 18         mov r11d, DWORD PTR [r8]               
  00029 45 89 da         mov r10d, r11d                         
  0002c 41 83 e2 0f      and r10d, 15                           
  00030 74 62            je .B7.9 
.B7.4::                         
  00032 44 89 d9         mov ecx, r11d                          
  00035 83 e1 03         and ecx, 3                             
  00038 75 10            jne .B7.6 
.B7.5::                         
  0003a 41 c1 ea 02      shr r10d, 2                            
  0003e 45 0b da         or r11d, r10d                          
  00041 41 ba 15 00 00 
        00               mov r10d, 21                           
  00047 44 89 d9         mov ecx, r11d                          
.B7.6::                         
  0004a 83 f1 03         xor ecx, 3                             
  0004d 41 bf ff ff ff 
        ff               mov r15d, -1                           
  00053 c1 e1 03         shl ecx, 3                             
  00056 41 83 c2 03      add r10d, 3                            
  0005a 41 d3 ef         shr r15d, cl                           
  0005d 45 23 df         and r11d, r15d                         
  00060 44 89 d9         mov ecx, r11d                          
  00063 c1 e9 04         shr ecx, 4                             
  00066 48 f7 d9         neg rcx                                
  00069 48 03 c8         add rcx, rax                           
  0006c 44 89 d5         mov ebp, r10d                          
  0006f 41 83 fa 10      cmp r10d, 16                           
  00073 f3 0f 6f 01      movdqu xmm0, XMMWORD PTR [rcx]         
  00077 f3 0f 7f 00      movdqu XMMWORD PTR [rax], xmm0         
  0007b 76 08            jbe .B7.8 
.B7.7::                         
  0007d 48 8b 49 10      mov rcx, QWORD PTR [16+rcx]            
  00081 48 89 48 10      mov QWORD PTR [16+rax], rcx            
.B7.8::                         
  00085 41 83 e3 03      and r11d, 3                            
  00089 48 03 c5         add rax, rbp                           
  0008c 41 ff c3         inc r11d                               
  0008f 4d 03 c3         add r8, r11                            
  00092 eb 22            jmp .B7.10 
.B7.9::                         
  00094 41 c1 eb 04      shr r11d, 4                            
  00098 44 89 d9         mov ecx, r11d                          
  0009b 41 83 e3 0f      and r11d, 15                           
  0009f f3 41 0f 6f 40 
        01               movdqu xmm0, XMMWORD PTR [1+r8]        
  000a5 41 ff c3         inc r11d                               
  000a8 48 83 e1 0f      and rcx, 15                            
  000ac f3 0f 7f 00      movdqu XMMWORD PTR [rax], xmm0         
  000b0 48 03 c1         add rax, rcx                           
  000b3 4d 03 c3         add r8, r11                            
.B7.10::                        
  000b6 4d 3b c1         cmp r8, r9                             
  000b9 0f 82 67 ff ff 
        ff               jb .B7.3 
*/

// ; 'Nakamichi_Kintaro+_branchfull' decompression loop, 64bit:
// ; Size in bytes: b5-21+6=154 bytes
// ; Size in instructions: 45
/*
; mark_description "Intel(R) C++ Intel(R) 64 Compiler XE for applications running on Intel(R) 64, Version 15.0.0.108 Build 20140";
; mark_description "-O3 -QxSSE2 -D_N_XMM -D_N_prefetch_4096 -D_N_Branchfull -D_N_HIGH_PRIORITY -FAcs";

.B7.3::                         
  00021 45 8b 18         mov r11d, DWORD PTR [r8]               
  00024 45 89 da         mov r10d, r11d                         
  00027 41 83 e2 0f      and r10d, 15                           
  0002b 75 29            jne .B7.5 
.B7.4::                         
  0002d 41 c1 eb 04      shr r11d, 4                            
  00031 49 8b 48 01      mov rcx, QWORD PTR [1+r8]              
  00035 45 89 da         mov r10d, r11d                         
  00038 41 83 e3 0f      and r11d, 15                           
  0003c 48 89 08         mov QWORD PTR [rax], rcx               
  0003f 41 ff c3         inc r11d                               
  00042 49 8b 68 09      mov rbp, QWORD PTR [9+r8]              
  00046 49 83 e2 0f      and r10, 15                            
  0004a 48 89 68 08      mov QWORD PTR [8+rax], rbp             
  0004e 49 03 c2         add rax, r10                           
  00051 4d 03 c3         add r8, r11                            
  00054 eb 5c            jmp .B7.8 
.B7.5::                         
  00056 44 89 d9         mov ecx, r11d                          
  00059 83 e1 03         and ecx, 3                             
  0005c 75 10            jne .B7.7 
.B7.6::                         
  0005e 41 c1 ea 02      shr r10d, 2                            
  00062 45 0b da         or r11d, r10d                          
  00065 41 ba 15 00 00 
        00               mov r10d, 21                           
  0006b 44 89 d9         mov ecx, r11d                          
.B7.7::                         
  0006e 83 f1 03         xor ecx, 3                             
  00071 bd ff ff ff ff   mov ebp, -1                            
  00076 c1 e1 03         shl ecx, 3                             
  00079 41 83 c2 03      add r10d, 3                            
  0007d d3 ed            shr ebp, cl                            
  0007f 44 23 dd         and r11d, ebp                          
  00082 44 89 dd         mov ebp, r11d                          
  00085 41 83 e3 03      and r11d, 3                            
  00089 c1 ed 04         shr ebp, 4                             
  0008c 41 ff c3         inc r11d                               
  0008f 48 f7 dd         neg rbp                                
  00092 48 03 e8         add rbp, rax                           
  00095 4d 03 c3         add r8, r11                            
  00098 48 8b 4d 00      mov rcx, QWORD PTR [rbp]               
  0009c 48 89 08         mov QWORD PTR [rax], rcx               
  0009f 48 8b 4d 08      mov rcx, QWORD PTR [8+rbp]             
  000a3 48 89 48 08      mov QWORD PTR [8+rax], rcx             
  000a7 48 8b 6d 10      mov rbp, QWORD PTR [16+rbp]            
  000ab 48 89 68 10      mov QWORD PTR [16+rax], rbp            
  000af 49 03 c2         add rax, r10                           
.B7.8::                         
  000b2 4d 3b c1         cmp r8, r9                             
  000b5 0f 82 66 ff ff 
        ff               jb .B7.3 
*/
...
https://1drv.ms/u/s!AmWWFXGMzDmEgltA4_n3-Q5v5XG6
...
// Railgun_Ennearch, copyleft 2014-Jan-15, Kaze.
// heptarch, noun.
// L17.  
...
static char * two_way_long_needle (const unsigned char *haystack, size_t haystack_len,
		     const unsigned char *needle, size_t needle_len)
{
  size_t i; /* Index into current byte of NEEDLE.  */
  size_t j; /* Index into current window of HAYSTACK.  */
